...
class JwtToken:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'JwtToken':
        return cls(
            _from_json_data(str, data.get("aud")),
            _from_json_data(str, data.get("cid")),
            _from_json_data(str, data.get("exp")),
            _from_json_data(str, data.get("iat")),
            _from_json_data(str, data.get("iss")),
            _from_json_data(str, data.get("jti")),
            _from_json_data(str, data.get("scp")),
            _from_json_data(str, data.get("sub")),
            _from_json_data(str, data.get("uid")),
            _from_json_data(str, data.get("ver")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["aud"] = _to_json_data(self.aud)
        data["cid"] = _to_json_data(self.cid)
        data["exp"] = _to_json_data(self.exp)
        data["iat"] = _to_json_data(self.iat)
        data["iss"] = _to_json_data(self.iss)
        data["jti"] = _to_json_data(self.jti)
        data["scp"] = _to_json_data(self.scp)
        data["sub"] = _to_json_data(self.sub)
        data["uid"] = _to_json_data(self.uid)
        data["ver"] = _to_json_data(self.ver)
        return data
